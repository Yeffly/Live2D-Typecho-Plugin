...
var timeout = 0;
var hiden = false;
console.log('%c Live2D 2.06 %c https://imalan.cn/archives/95/ ', 'color: #fadfa3; background: #23b7e5; padding:5px 0;', 'background: #1c2b36; padding:5px 0;');
function showLive2D() {
...
if (!dMobile) {
    window.setInterval(function() {
        ...
        if (timeout <= 0) {
            $('#l2d-message').css("transform", "translateX(-15.2em)")
        }
    },
    500)
}
...
$("#l2d-message").hover(function() {
    showMessage("猜猜我会说什么？", 3000)
});
